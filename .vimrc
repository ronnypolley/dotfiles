...
" set line number and use relative numbers
...
let g:vimtex_view_general_options
    ...
    \ . ' -inverse-search "nvim --servername ' . v:servername
    \ . ' --remote-send \"^<C-\^>^<C-n^>'
...
" LanguageTool Setup
let g:languagetool_jar='c:/tools/languagetool/languagetool-commandline.jar'
